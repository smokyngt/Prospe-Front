...
import GeneralInfoContent from '../../../../components/common/dashboardComponent/assistant/settings/profile.assistant'
import SettingsContent from '../../../../components/common/dashboardComponent/assistant/settings/settings.assistant'
import DeleteContent from '../../../../components/common/dashboardComponent/assistant/settings/delete.assistant'
...
const SettingsAssistant: React.FC = () => {
  ...
  return (
    <>
      <SidebarAssistant title={'Settings'} />
      <div className="p-4 bg-white ml-64">
        <div className="p-4 rounded-lg w-2/3">
          ...
          <div className="flex gap-4 mb-4 border border-gray-200 p-1 rounded-lg justify-around">
            {options.map(option => (
              <button
                key={option}
