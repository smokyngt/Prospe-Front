...
import SidebarUser from '@/components/common/dashboardComponent/user/sidebar.user';
import GridAssistantUser from '../../../components/common/dashboardComponent/user/gridAssistant.user';
// import ConversationBox from '../../../components/common/Dashboard/user/conversationBox.user';
...
const DashboardUser: React.FC = () => {
  ...
  return (
    <>
      <SidebarUser title={'home'} />
      <div className="w-full lg:ps-64 flex justify-center">
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 flex flex-col items-center w-full max-w-5xl">
          {error && (
