...
const SidebarUser: React.FC<SidebarProps> = ({ title }) => {
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 px-4 space-y-1 text-sm font-medium text-gray-700">
          ...
          {/* Stats */}
          <a href="/stats" className="flex items-center gap-3 p-2 text-sm hover:bg-orange-50 rounded-lg transition">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />
        ...
        <div className="mt-3 mb-4 px-3">
            <a href="/help" className="flex items-center gap-3 p-2 text-sm hover:bg-gray-100 rounded-lg transition font-semibold text-gray-600">
            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <a href="/support" className="flex items-center gap-3 p-2 text-sm hover:bg-gray-100 rounded-lg transition text-gray-600 font-semibold">
